"""
Complete Lucide icon SVG paths for email HTML export.
Auto-generated from lucide-react v1.0.1 — 1686 icons.
"""
...
LUCIDE_PATHS: dict[str, str] = {
    ...
    # ── Custom creator & wellness icons ──
    'yoga-pose': '<path d="M12 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"/><path d="M6 20l3-8"/><path d="M18 20l-3-8"/><path d="M9 12l3-4 3 4"/><path d="M4 16l5-4"/><path d="M20 16l-5-4"/>',
    'yoga-tree': '<path d="M12 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"/><path d="M12 5v17"/><path d="M8 9l4 2 4-2"/><path d="M16 14l-4 1-4-1"/><path d="M9 22h6"/>',
    'yoga-lotus': '<path d="M12 22c-4 0-7-2-7-5 0-2 1.5-3.5 3-4"/><path d="M12 22c4 0 7-2 7-5 0-2-1.5-3.5-3-4"/><path d="M12 22v-6"/><path d="M8 13c-2-2-3-5-1-7s5-2 5 1"/><path d="M16 13c2-2 3-5 1-7s-5-2-5 1"/><circle cx="12" cy="5" r="1.5"/>',
    'meditation': '<path d="M12 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"/><path d="M8 14c-3 0-5 1-5 3s4 4 9 4 9-2 9-4-2-3-5-3"/><path d="M12 5v4"/><path d="M8 9h8"/><path d="M10 13l2-4 2 4"/>',
    'lotus': '<path d="M12 20c-4 0-8-2-8-6 0-3 2.5-5 5-6"/><path d="M12 20c4 0 8-2 8-6 0-3-2.5-5-5-6"/><path d="M12 20V8"/><path d="M7 8c-1-3 0-6 3-7"/><path d="M17 8c1-3 0-6-3-7"/><path d="M12 1c-2 2-2 5 0 7"/><path d="M12 1c2 2 2 5 0 7"/>',
    'pilates': '<path d="M12 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"/><path d="M4 18h16"/><path d="M7 18l2-8 3 2 3-2 2 8"/><path d="M10 12V8"/><path d="M14 12V8"/>',
    'dancer': '<path d="M12 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"/><path d="M10 22l2-10"/><path d="M14 22l-2-10"/><path d="M12 12l-5-4"/><path d="M12 12l5-2"/><path d="M17 10c1-2 2-5 0-7"/><path d="M7 8L4 6"/>',
    'ballet': '<path d="M12 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"/><path d="M12 5v8"/><path d="M12 13l-4 9"/><path d="M12 13l4 9"/><path d="M8 9c-2-1-4 0-4 2"/><path d="M16 9c2-1 4 0 4 2"/><path d="M8 9l4 1 4-1"/>',
    'bellydance': '<path d="M12 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"/><path d="M12 5v5"/><path d="M8 10c0 3 2 5 4 6s4-3 4-6"/><path d="M6 16c2 4 4 6 6 6s4-2 6-6"/><path d="M7 8l5 2 5-2"/>',
    'stretching': '<path d="M12 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"/><path d="M4 17l4-5 4 1"/><path d="M12 13l4-1 4 5"/><path d="M12 13v9"/><path d="M8 8l4 1 4-1"/>',
    'face-yoga': '<circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><circle cx="9" cy="9" r="0.5" fill="currentColor"/><circle cx="15" cy="9" r="0.5" fill="currentColor"/><path d="M9 9v1"/><path d="M15 9v1"/>',
    'breathwork': '<path d="M12 22V8"/><path d="M5 12c0-4 3-8 7-10"/><path d="M19 12c0-4-3-8-7-10"/><path d="M5 12c0 4 3 8 7 10"/><path d="M19 12c0 4-3 8-7 10"/><circle cx="12" cy="5" r="1.5"/>',
    'wellness': '<path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10Z"/><path d="M12 6v2"/><path d="M12 16v2"/><path d="M6 12h2"/><path d="M16 12h2"/><path d="M12 10a2 2 0 1 0 0 4 2 2 0 0 0 0-4Z"/>',
    'spa': '<path d="M12 2c3 4 6 6 6 10a6 6 0 1 1-12 0c0-4 3-6 6-10Z"/><path d="M12 12v6"/><path d="M9 15h6"/>',
    'candle': '<path d="M12 2c1 1 2 3 2 5s-1 3-2 3-2-1-2-3 1-4 2-5Z"/><rect x="9" y="10" width="6" height="12" rx="1"/><path d="M9 16h6"/>',
    'mindfulness': '<circle cx="12" cy="12" r="10"/><path d="M12 6c-2 2-3 4-3 6s1 4 3 6"/><path d="M12 6c2 2 3 4 3 6s-1 4-3 6"/><path d="M6 12h12"/>',
    'running': '<path d="M13 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"/><path d="M4 22l5-8"/><path d="M20 17l-4-5-3 1-2-3-4 2"/><path d="M13 13l4 4"/><path d="M7 11l4-2"/>',
    'swimming': '<path d="M2 18c2-1 3-1 5 0s3 1 5 0 3-1 5 0 3 1 5 0"/><path d="M2 22c2-1 3-1 5 0s3 1 5 0 3-1 5 0 3 1 5 0"/><circle cx="12" cy="8" r="1.5"/><path d="M8 14l4-4 4 2"/>',
    'fitness': '<path d="M4 7h16"/><path d="M6 7v10"/><path d="M18 7v10"/><path d="M4 17h16"/><rect x="2" y="9" width="4" height="6" rx="1"/><rect x="18" y="9" width="4" height="6" rx="1"/><path d="M6 12h12"/>',
    'jump-rope': '<circle cx="12" cy="4" r="1.5"/><path d="M12 6v5"/><path d="M8 22c0-5 1-8 4-11"/><path d="M16 22c0-5-1-8-4-11"/><path d="M6 8c-2 2-3 6-3 10"/><path d="M18 8c2 2 3 6 3 10"/>',
    'martial-arts': '<path d="M12 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"/><path d="M12 5v6"/><path d="M6 8l6 3 6-3"/><path d="M12 11l-5 11"/><path d="M12 11l5 11"/><path d="M4 8l3-2"/>',
    'singing': '<path d="M12 18v4"/><path d="M9 22h6"/><rect x="9" y="2" width="6" height="12" rx="3"/><path d="M5 10a7 7 0 0 0 14 0"/>',
    'painting': '<path d="M2 22l1-1h3l9-9"/><path d="M15 12l-3-3"/><path d="M13 7l5-5c1-1 3 0 3 0s1 2 0 3l-5 5"/><path d="M22 2l-1 1"/>',
    'pottery': '<path d="M8 22h8"/><path d="M8 22c-2 0-3-1-3-3v-3c0-2 1.5-3 3-4"/><path d="M16 22c2 0 3-1 3-3v-3c0-2-1.5-3-3-4"/><path d="M8 12V6c0-2 2-4 4-4s4 2 4 4v6"/><path d="M10 8h4"/>',
    'knitting': '<path d="M3 22l4-18"/><path d="M7 22l4-18"/><path d="M3 10c2-1 4 1 4 1s2-2 4-1"/><path d="M3 14c2-1 4 1 4 1s2-2 4-1"/><path d="M3 18c2-1 4 1 4 1s2-2 4-1"/><path d="M14 4l3 18"/><path d="M17 4l3 18"/>',
    'cooking': '<path d="M12 2v4"/><path d="M6 6h12"/><path d="M6 6l1 16h10l1-16"/><circle cx="12" cy="13" r="2"/><path d="M4 6l-1 2"/><path d="M20 6l1 2"/>',
    'photography': '<rect x="2" y="6" width="20" height="14" rx="2"/><circle cx="12" cy="13" r="4"/><circle cx="12" cy="13" r="1.5"/><path d="M14 2h-4l-1 4h6l-1-4Z"/>',
...
def lucide_svg_string(name: str, size: int, color: str, stroke_width: float = 2) -> str:
    ...
    return (
        ...
        f'viewBox="0 0 24 24" fill="none" stroke="{color_safe}" '
        f'stroke-width="{stroke_width}" stroke-linecap="round" stroke-linejoin="round">'
        f'{paths}</svg>'
    )


def lucide_data_uri(name: str, size: int, color: str, stroke_width: float = 2) -> str:
    """Generate a data URI for a Lucide icon SVG (for <img> tags in email)."""
    svg = lucide_svg_string(name, size, color, stroke_width)
    if not svg:
        return ''
